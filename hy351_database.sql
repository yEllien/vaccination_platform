...
-- Χρόνος δημιουργίας: 16 Μάη 2022 στις 19:07:26
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateDosesAndState` (IN `ssn` VARCHAR(11), IN `doseNum` INT)  BEGIN 
    ...
    JOIN books b ON b.hospitalID = hv.hospitalID and b.citizenSSN = ssn;
    ...
    IF (maxDoses = 2) THEN 
    	IF (doseNum = 1) THEN
        	UPDATE citizen
            SET dosesCompleted = doseNum, vaccinationState = 'partialy vaccinated'
...
('Angelo', 'Morris', '02010000992', 'male', '2000-01-02', '', 0),
('Mareli', 'Bender', '02024511750', 'male', '1945-02-02', '', 0),
('Leonardo', 'Ferrell', '03027412995', 'male', '1974-02-03', '', 0),
('Cherish', 'Mejia', '06067500198', 'male', '1975-06-06', '', 0),
('Niko', 'Curry', '07049610092', 'male', '1996-04-07', '', 0),
('Ricky', 'Salinas', '09108078512', 'male', '1980-10-09', '', 0),
('Jake', 'Lester', '09118460019', 'male', '1984-11-09', '', 0),
('Abdiel', 'Moreno', '11017426134', 'male', '1974-01-11', '', 0),
('Chace', 'Downs', '11018009871', 'male', '1980-01-11', '', 0),
('Kenna', 'Manning', '11018701926', 'female', '1987-01-11', '', 0),
('Leland', 'Chapman', '12109200956', 'female', '1992-10-12', '', 0),
('Ricky', 'Salinas', '13117690374', 'male', '1976-11-13', '', 0),
('Aubrey', 'Proctor', '15059775840', 'female', '1997-05-15', '', 0),
('Dean', 'Arellano', '16096536000', 'male', '1965-09-16', '', 0),
('Fernanda', 'Ali', '18079318729', 'female', '1993-07-18', '', 0),
('Brycen', 'Valentine', '18090119872', 'male', '2001-09-18', '', 0),
('Mckinley', 'Bush', '25036650948', 'male', '1966-03-25', '', 0),
('Jessica', 'Deleon', '26055743567', 'female', '1957-05-26', '', 0),
('Kyle', 'Dalton', '26116473859', 'male', '1964-11-26', '', 0),
('Jayden', 'Ortiz', '27108645329', 'female', '1986-10-27', '', 0),
('Roger', 'Villegas', '29056154620', 'male', '1961-05-29', '', 0);
...
('20309', '2022-05-26', '08:00-12:00', 6),
